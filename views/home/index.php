    ...
    <div class="main_left col-12 col-md-9 bg-white">
        ...
        <div class="featured pt-3">
            <div class="featured-item">
                <a href="/article/6.html">
                    <img class="w-100 artcle_thumb" src="http://www.forex.com.cn/assets/www/headline1526000576.png">
                </a>
                <h5>少听大忽悠的AI万能论：不打开四道锁，企业永远无法享用AI</h5>
            </div>
            <div class="featured-item">
                <a href="/article/6.html">
                    <img class="w-100 artcle_thumb" src="http://www.forex.com.cn/assets/www/headline1526000576.png">
        ...
        <div class="artcle_list">
            ...
            <ul class="list-unstyled">
                <li class="media">
                    <img class="mr-3 artcle_thumb rounded" src="/assets/images/Parallax.jpg"
                         alt="Generic placeholder image">
                    <div class="media-body">
                        <h5 class="mt-1">Bootstrap4之弹性盒子详解flexbox</h5>
    ...
    <div class="main_right col-12 col-md-3 bg-white pt-3">
            ...
            <ul class="list-unstyled artcle_list">
                <li class="media">
                    ...
                    <div class="media-body">
                        ...
                        <div class="media-footer">5.5k 人已阅读</div>
                    </div>
                </li>
                <li class="media">
                    <img class="mr-3 rounded artcle_thumb_small" src="/assets/images/Parallax.jpg"
        ...
        <div class="total-info">
            ...
            <ul class="list-unstyled pt-3">
                <li><strong>文章总数：</strong>29篇</li>
                <li><strong>评论总数：</strong>22条</li>
                <li><strong>最后更新：</strong>2018-06-06</li>
            </ul>
        </div>
        <!--统计 end-->
    </div>
